...
extern const ISimNode ISimNode_GetElementNode;
extern const ISimNode ISimNode_GetValueElementNode;
extern const ISimNode ISimNode_GetPointerElementNode;
extern const ISimNode ISimNode_SetNode;
extern const ISimNode ISimNode_SetElementNode;
