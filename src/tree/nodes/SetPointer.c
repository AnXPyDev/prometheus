...
Node SetPointerNode_copy(void *vthis, Allocator alc) {
	return SetPointerNode_create(
		Node_copy(this->pointer, alc),
		Node_copy(this->value, alc),
		alc
	);
}
