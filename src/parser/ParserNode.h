...
extern const IParserNode IParserNode_GetElementNode;
extern const IParserNode IParserNode_GetValueElementNode;
extern const IParserNode IParserNode_GetPointerElementNode;
extern const IParserNode IParserNode_SetNode;
extern const IParserNode IParserNode_SetElementNode;
