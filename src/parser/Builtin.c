...
void Parser_setupBuiltins(ParserContext *ctx) {
	...
	Parser_setupKeyword(frame, "defer", PARSER_KEYWORD_DEFER, alc);
	...
	Parser_setupKeyword(frame, "as", PARSER_KEYWORD_CAST, alc);

	Parser_setupKeyword(frame, "&ptr", PARSER_KEYWORD_TAKE_PTR, alc);
	Parser_setupKeyword(frame, "*ptr", PARSER_KEYWORD_GET_PTR, alc);

	Parser_setupKeyword(frame, "=", PARSER_KEYWORD_SET, alc);
	Parser_setupKeyword(frame, "=ptr", PARSER_KEYWORD_SET_PTR, alc);
	
	Parser_setupKeyword(frame, "struct", PARSER_KEYWORD_STRUCT, alc);
	Parser_setupKeyword(frame, "interface", PARSER_KEYWORD_INTERFACE, alc);
}
